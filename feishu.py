...
class FeiShu:
    ...
    def get_tenant_access_token(self):
        ...
        data = {"app_id": self.APP_ID, "app_secret": self.FEISHU_APP_SECRET}
    ...
    def send_img_feishu(self, filepath):
        ...
        data = {
            ...
            "msg_type": "image",
            "content": json.dumps({"image_key": f"{img_key}"}),
    ...
    def send_msg_feishu(self, text):
        ...
        data = {
            "receive_id": self.FEISHU_RECEIVE_ID,
            "msg_type": "text",
            "content": json.dumps({"text": f"{text}"}),
            "uuid": str(int(time.time())),
        }
        payload = json.dumps(data)
